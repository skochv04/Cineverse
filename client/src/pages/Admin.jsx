        ...
        <div className="Admin">
            ...
            {currentMode === "View Data" && (
                <>
                    ...
                    <div className="container">
                        ...
                        <button className="blue" onClick={() => openModal("View Movie Screenings")}>View Movie
                            Screenings
                        </button>
                    </div>
                </>
            ...
            {currentMode === "Data manager" && (
                <>
                    ...
                    <div className="container">
                        <button className="green" onClick={() => openModal("Add New Category")}>Add New Category
                        </button>
                    ...
                    <h2>Movies</h2>
                    <div className="container">
                        <button className="green" onClick={() => openModal("Add New Movie", handleMovie)}>Add New
                            Movie
                        </button>
                        <button className="white" onClick={() => openModal("Update Movie", handleMovie)}>Update Movie
                        </button>
                    ...
                    <div className="container">
                        <button className="green" onClick={() => openModal("Add Week-Templated Movie Screenings")}>Add
                            Week-Templated Movie Screenings
                        </button>
                        <button className="red" onClick={() => openModal("Delete Movie Screening")}>Delete Movie
                            Screening
                        </button>
                    </div>
                </>
            ...
            {currentMode === "Data analysis" && (
                <>
                    <h2>MovieScreening</h2>
                    <div className="container">
                        <button className="blue" onClick={() => openModal("Show Movie Screenings by Hall")}>Show Movie
                            Screenings by Hall
                        </button>
                        <button className="blue" onClick={() => openModal("Show revenue for Movie on OrderDate")}>Show
                            revenue for Movie on OrderDate
                        </button>
                        <button className="blue"
                                onClick={() => openModal("Show average prices per category over past/upcoming 6 months")}>Show
                            average prices per category over past/upcoming 6 months
                        </button>
                        <button className="blue" onClick={() => openModal("Show today Movie Screenings")}>Show today
                            Movie Screenings
                        </button>
                    </div>
                </>
            ...
            >
                                    ...
                                    {movies.map((movie, index) => (
                                        <li key={index}>
                                            <button class="list-button"
                                                    onClick={() => handleClick(movie)}>{movie.title}</button>
                                        </li>
                                    ))}
                                </ul>
                            ) : (
                ...
                {selectedMovie && (
                    <div className="modal-content-scrollable">
                        <div className="movie-details-img">
                            {selectedMovie.image &&
                                <img src={`data:image/jpeg;base64,${selectedMovie.image}`} alt={selectedMovie.title}/>}
                        </div>
                            ...
                            {screenings.length > 0 ? (
                                <ul className="movie-list">
                                    {screenings.map((screening, index) => (
                                        <li key={index}>
                                            <button class="list-button"
                                                    onClick={() => handleScreeningClick(screening)}>{screening.title} - {screening.date} {screening.starttime}</button>
                                        </li>
                                    ))}
                                </ul>
                            ) : (
                ...
                {selectedScreening && (
                    <div className="modal-content-scrollable">
                        <div className="movie-details-img">
                            {selectedScreening.image && <img src={`data:image/jpeg;base64,${selectedScreening.image}`}
                                ...
                                <ul className="category-list">
                                    {average.map((category, index) => (
                                        <li key={index}>
                                            ...
                                            <span><b>Movies Screenings Amount:</b> {category.moviescreenings_amount}
                                                <br/></span>
                                            <span><b>Average Price (Standard):</b> {category.average_pricestandard}
                                                <br/></span>
