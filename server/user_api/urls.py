...
from .views import handle_movie_category, delete_movie_by_name, handle_movie, handle_movie_screening, \
    delete_movie_screening, handle_reservation
...
urlpatterns = [
    ...
    path('user/<str:user_name>/tickets/', views.get_tickets_for_user, name='get_tickets_for_user'),
