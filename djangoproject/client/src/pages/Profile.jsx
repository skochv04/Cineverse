...
function Profile({ currentPassword, setCurrentPassword, newPassword, setNewPassword, showCurrentPassword, toggleShowCurrentPassword, showNewPassword, toggleShowNewPassword }) {
    return (
